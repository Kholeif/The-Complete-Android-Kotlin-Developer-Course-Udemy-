...
//        mMap.addMarker(MarkerOptions().position(sydney).title("Me").snippet("here is mario location").icon(BitmapDescriptorFactory.fromResource(R.drawable.mario)))
//        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(sydney,14f))
    ...
    fun  LoadPockemon(){
        ...
        listPockemons.add(Pockemon(R.drawable.charmander,
            "Charmander", "Charmander living in japan", 55.0, 30.0606628537, 31.3499593735))
